...
ROBOT_TURN_RADIUS_FL_CM = 24.3   # Forward-Left arc radius  (tune this!)
ROBOT_TURN_RADIUS_FR_CM = 24.2   # Forward-Right arc radius (tune this!)
ROBOT_TURN_RADIUS_BL_CM = 23.1   # Back-Left arc radius     (tune this!)
ROBOT_TURN_RADIUS_BR_CM = 26   # Back-Right arc radius    (tune this!)
