...
def path_finding():
    ...
    waypoint_path, distance = maze_solver.get_optimal_order_dp(retrying=retrying)

    # Step 2: Generate commands from path
    commands = command_generator(waypoint_path, obstacles)
