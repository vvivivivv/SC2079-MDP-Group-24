...
View Cone Generation (updated for wide-angle capture):
  ...
  - Max incidence angle: 75 deg (wide FOV allows steep approaches)
...
APPROACH_ANGLES_DEG = [-70, -55, -40, -25, 0, 25, 40, 55, 70]
...
PENALTY_CENTER = 0
PENALTY_MILD_ANGLE = 1      # 0-25 deg (excellent)
PENALTY_MODERATE_ANGLE = 2   # 25-45 deg (good)
PENALTY_STEEP_ANGLE = 5      # 45-70 deg (readable but foreshortened)
PENALTY_EXTREME_ANGLE = 8    # 70-75 deg (barely readable, last resort)
PENALTY_FAR = 3
PENALTY_CLOSE = 0
