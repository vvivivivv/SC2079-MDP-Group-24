...
def path_to_commands(path):
    ...
    Long arc commands are broken into ≤20cm chunks for better
    real-world accuracy (arc error accumulates with distance).
    """
    MAX_ARC_CMD_CM = 20
